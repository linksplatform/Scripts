...
IGNORE_OUTPUT1=$(find "./csharp/Platform.$REPOSITORY_NAME/obj" -type f -iname "*.cs" -delete)
IGNORE_OUTPUT2=$(find "./csharp/Platform.$REPOSITORY_NAME.Tests/obj" -type f -iname "*.cs" -delete)
